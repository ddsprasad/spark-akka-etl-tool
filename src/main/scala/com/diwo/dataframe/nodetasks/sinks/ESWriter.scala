...
object ESWriter {
  ...
  val esWriter = (optionsIn: NodeTaskOptions, dataframe: DataFrame) => {
    ...
    var result = t1-t0
    ModuleApp.logger.info(s"TASK: ${ESWriter.getClass} SUCCESFULLY DONE IN JUST $result")
  ...
  TasksRegistryHandler.tasksRegistry.put("eswriter", esWriter)
}
